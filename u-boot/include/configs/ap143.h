...
#elif defined(CONFIG_FOR_MINI_V2)
	#define CONFIG_QCA_GPIO_MASK_LED_ACT_L GPIO4 | GPIO12 | GPIO16
	#define CONFIG_QCA_GPIO_MASK_WDT_ACT_L GPIO0
	#define CONFIG_QCA_GPIO_MASK_RESET_BTN	GPIO17
	#define CONFIG_QCA_GPIO_MASK_LTE		GPIO15
	#define CONFIG_QCA_GPIO_MASK_IN		CONFIG_QCA_GPIO_MASK_RESET_BTN
	#define CONFIG_QCA_GPIO_MASK_OUT	CONFIG_QCA_GPIO_MASK_LED_ACT_L | CONFIG_QCA_GPIO_MASK_LTE | CONFIG_QCA_GPIO_MASK_WDT_ACT_L
	#define CONFIG_QCA_GPIO_MASK_OUT_INIT_H	CONFIG_QCA_GPIO_MASK_LED_ACT_L
	#define CONFIG_QCA_GPIO_MASK_OUT_INIT_L	CONFIG_QCA_GPIO_MASK_LTE

#elif defined(CONFIG_FOR_9531_V2)
	#define CONFIG_QCA_GPIO_MASK_LED_ACT_L GPIO4 | GPIO12 | GPIO16
	#define CONFIG_QCA_GPIO_MASK_WDT_ACT_L GPIO0
	#define CONFIG_QCA_GPIO_MASK_RESET_BTN	GPIO17
	#define CONFIG_QCA_GPIO_MASK_LTE		GPIO15
...
#elif defined(CONFIG_FOR_MINI_V2)
	#define CONFIG_BOOTARGS "console=ttyS0,115200 root=31:4 "\
				"rootfstype=jffs2 init=/sbin/init "\
				"mtdparts=ath-nor0:128k(u-boot),64k(u-boot-env),64k(art),64k(config),14400k(rootfs),1664k(kernel),16064k(firmware)"
 ...
 */
	...
	#define OFFSET_MAC_DATA_BLOCK	0x10000
	#define OFFSET_MAC_DATA_BLOCK_LENGTH	0x10000
	#define OFFSET_MAC_ADDRESS		0x00FE00
	#define OFFSET_ROUTER_MODEL		0x00FD00
	#define OFFSET_PIN_NUMBER		0x00FF00
#elif defined(CONFIG_FOR_9531_V2)
	#define OFFSET_MAC_DATA_BLOCK	0x10000
	#define OFFSET_MAC_DATA_BLOCK_LENGTH	0x10000
	#define OFFSET_MAC_ADDRESS		0x00FE00
 ...
 */
	...
	#define CONFIG_QCA_PLL_IN_FLASH_BLOCK_SIZE	0x10000
      ...
      defined(CONFIG_FOR_YUNCORE_AP90Q)  ||\
      defined(CONFIG_FOR_YUNCORE_CPE830) ||\
	  defined(CONFIG_FOR_MINI_V2)		 ||\
	  defined(CONFIG_FOR_9531_V2)		 ||\
      defined(CONFIG_FOR_ZBTLINK_ZBT_WE1526)
